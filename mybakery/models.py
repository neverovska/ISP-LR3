...
#     slug = models.SlugField(max_length=50, db_index=True, unique=True, default='')
#
#     class Meta:
...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=100, db_index=True, unique=True, default='')
    ...
    calories = models.DecimalField(max_digits=5, decimal_places=1, default=0)
